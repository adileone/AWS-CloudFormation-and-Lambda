...
public class ManageEvents implements RequestHandler<Object, String> {
	...
	public ManageEvents() {
		...
		try {
			...
			sesClient = AmazonSimpleEmailServiceClientBuilder.standard()
					.withCredentials(new AWSStaticCredentialsProvider(getSTSsession()))
					.withRegion(Regions.EU_CENTRAL_1).build();

		} catch (Exception e) {
			//In Dev no CrossAccountARN needed
			sesClient = AmazonSimpleEmailServiceClientBuilder.standard()
					.withRegion(Regions.EU_CENTRAL_1).build();
		}
	...
	public String handleRequest(Object input, Context context) {
		...
		//Is CWLog
			...
			try {
				...
				String s3BucketDestination = "alessandrotestbucket";
				String destinationPrefix = "logs-export";				

				String taskId = shipLogs(s3BucketDestination, destinationPrefix, timestampJson, logGroup, logStream);
	...
	public String shipLogs(String s3BucketName, String destinationPrefix, Long unixTimestamp, String logGroup, String logStream) {
		...
		CreateExportTaskRequest createExportTaskRequest = new CreateExportTaskRequest()
				...
				.withDestinationPrefix("logs-export")
	...
	public BasicSessionCredentials getSTSsession() {

		String crossAccountRoleArn = System.getenv("CrossAccountRoleARN");

		if (crossAccountRoleArn==null) {
			logger.log("Please Check the SysEnv CrossAccountARN. It seems to be null.");
			logger.log("assuming default value for acceptance env.");

			crossAccountRoleArn = "arn:aws:iam::716241334947:role/ses-role-pct-acc";
		}
	...
	public ArrayList<String> getRecipients(String projID) {
		...
		String paramListOfRecipientsName="/"+project+"/ListOfRecipientsTest";			
