...
public class CommonUtils {
	...
	public static ArrayList<String> getRecipients(String projID, AWSSimpleSystemsManagement ssmClient) {
		
		String[] splitted = projID.split("-", 2); 
		String project=splitted[0];			
		String paramName="/"+project+"/ListOfRecipients";	
	...
	public static String getSender(String projID, AWSSimpleSystemsManagement ssmClient) {
		String[] splitted = projID.split("-", 2); 
		String project=splitted[0];
